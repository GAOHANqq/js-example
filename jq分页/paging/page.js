;(function(){
    ...
    function Pagination(data){
        this.dom = document.getElementById(data.id); // 容器
        this.cur = data.cur; // 当前页
        this.total = data.total; // 总数目
        this.flag = false;
        this.fn = data.change; // 变化函数
        this.spans = [];
        this.num_btns = [];
        this.init();
    };
    Pagination.prototype.init = function(){
        ...
        this.spans[0].className = 'btn';
        this.spans[10].className = 'btn';
