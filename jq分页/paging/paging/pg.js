(function($, window, document) {
	...
	Paging.prototype = {
		...
		createDom : function() {
			...
			that.options.jump 
				? jumpDom = '<input type="text" placeholder="1" class="jump-text" id="jumpText"><button type="button" class="jump-button" id="jumpBtn">跳转</button>'
				: jumpDom = '';
		...
		bindEvents : function() {
			...
			function handles(pageIndex) {
				...
				pageSelect.width(totalPages*liWidth);
